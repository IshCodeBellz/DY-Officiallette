  ...
  reviews: [
    {
      ...
      starRating: "FIVE",
      comment: "Outstanding online shopping experience! The website is user-friendly, checkout was quick, and my order arrived perfectly packaged. The clothes are exactly as shown in the photos and the quality is top-notch.",
    ...
    },
    {
      ...
      starRating: "FIVE",
      comment: "Fantastic selection and prices! I've been shopping here for months and have never been disappointed. Fast shipping, easy returns, and customer service is always helpful and responsive.",
    ...
    },
    {
      ...
      starRating: "FOUR",
      comment: "Really impressed with the quality and style of the items I purchased. Delivery was on time and everything was well-packaged. Only minor suggestion would be to add more size guides for some brands.",
    ...
    },
    {
      ...
      starRating: "FIVE",
      comment: "Love this store! Great brands, competitive prices, and excellent customer service. The mobile app makes shopping so convenient. Highly recommend to anyone looking for quality fashion online.",
    ...
    },
    {
      ...
      starRating: "FIVE",
      comment: "Been a customer for over a year now and consistently impressed with the service. Orders always arrive quickly and accurately. The return process is straightforward when needed. Definitely my go-to for online fashion shopping!",
    ...
    },
    {
      ...
      starRating: "FOUR",
      comment: "Great selection of products and brands. The search function works well and filtering options make it easy to find what you're looking for. Shipping is reliable and packaging is always secure.",
